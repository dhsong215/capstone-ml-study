...
| 03 | [피처 엔지니어링 설계](./03-피처-엔지니어링-설계.md) | 6개 그룹 피처 (검색 모멘텀, 소셜 버즈, 교차 상관, 컨텍스트, **연관어 TF-IDF+PCA 벡터**, **거시경제 지표**), ablation study 설계 |
| 04 | [모델 선택 및 비교 분석](./04-모델-선택-및-비교-분석.md) | Dummy/LR/XGBoost/LSTM 원리, 앙상블, 다각도 비교, 학술 근거, **학습 시간 및 클라우드 비용** |
